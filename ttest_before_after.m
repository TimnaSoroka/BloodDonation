...
[Laterality_IndexB(i),BmeasureResults_con(i)]=NasalCycleParameters_short(NCbefore{i},Fs,0,'Holter');
[Laterality_IndexA(i),AmeasureResults_con(i)]=NasalCycleParameters_short(NCafter{i},Fs,0,'Holter');
...
for i=1:size(NCbefore,2)
[Laterality_IndexB(i),BmeasureResults(i)]=NasalCycleParameters_short(NCbefore{i},Fs,0,'Holter');
[Laterality_IndexA(i),AmeasureResults(i)]=NasalCycleParameters_short(NCafter{i},Fs,0,'Holter');
%[Laterality_IndexD(i),DmeasureResults(i)]=NasalCycleParameters(NCdonation{i},Fs,noiseThreshold);
end
